...
All notable changes to `elegancecms/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/elegancecms/git-commit-checker/pull/10)
